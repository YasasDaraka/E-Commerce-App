    ...
    <div className="flex-1 min-h-screen flex flex-col justify-between">
      ...
      <div className="flex flex-row justify-between w-full relative">
          <p className="text-2xl font-medium text-gray-600 ">
            Manage <span className="font-medium text-orange-600">Product</span>
          </p>
        ...
        <div className="flex flex-row items-center">
          ...
          <div className="flex flex-col w-38 ml-14 relative">
            ...
            <select
              ...
              name="colour"
              className="outline-none py-2 px-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500/40 focus:border-transparent text-gray-600"
        ...
        <div className="flex flex-col gap-1 max-w-md relative">
          ...
          <textarea
            name="description"
            rows={4}
            className="outline-none md:py-2.5 py-2 px-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500/40 focus:border-transparent resize-none"
            placeholder="Type here"
            onChange={handleInputChange}
        ...
        <button
          ...
          type="button"
          className="px-10 py-1.5 mt-2 text-white rounded-full bg-[#F88655] hover:bg-orange-500 font-medium"
        >
