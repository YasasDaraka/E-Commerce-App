      ...
      {loading ? <Loading /> : <div className="w-full md:p-10 p-4">
        ...
        <div className="flex flex-row justify-between w-full mb-8">
          <p className="text-2xl font-medium text-gray-600 ">
            All <span className="font-medium text-orange-600">Products</span>
          </p>
          ...
          onClick={() =>{ setRemove(""); setSearch(""); setSearchError(false); setSearchedProduct(""); getAllProducts();}}/>}
            <img onClick={getProduct} className="w-5 h-5 mr-2 hover:bg-orange-500/40 hover:rounded-full" src={assets.search_icon} alt="search icon" />
              ...
              products.map((product:any, index:any) => (
                <tr key={index} className="border-t border-gray-500/20">
                  ...
                  <td className="px-6 py-3 text-gray-500/90 font-medium">
                    <button onClick={() => setRemove(product.itemName)} className="flex items-center gap-1 px-3.5 py-1.5 text-white rounded-full bg-[#F88655] hover:bg-orange-500">
                      <span className="hidden md:block">Remove </span>
                    </button>
                  </td>
                  <td className="px-7 py-3 text-gray-500/90 font-medium">
                    <button onClick={() => navigate(`/products/${product.itemName}`)} className="flex items-center gap-1 px-3.5 py-1.5 text-white rounded-full bg-[#F88655] hover:bg-orange-500">
