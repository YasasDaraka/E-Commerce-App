        ...
        <p className="text-2xl md:text-3xl font-medium text-orange-600 ">
            Card <span className="text-gray-500">Information</span>
              ...
              <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <select
                        ...
                        onChange={handleInputChange}
                        className="p-2 border rounded border-gray-300 focus:border-orange-600 focus:outline-none focus:ring-0"
                      >
                ...
                <button disabled={!btn} onClick={()=>{setReady()}} className={`text-sm text-white px-3 py-1 rounded-md ${!btn ?"bg-gray-300/80":"bg-[#F88655] hover:bg-orange-600"}`}>
                    Confirm
                </button>
            </div>
  )
