...
const About = () => {
  ...
  return (
    <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10">
      ...
      <div data-aos="fade-down" className="bg-[#EEF0F6]/90 rounded-lg overflow-hidden">
      ...
      <div data-aos="fade-right" className="grid grid-cols-1 md:grid-cols-2 gap-16 py-10">
        <div className="flex flex-col">
          ...
          <p className="text-gray-600">
            Each product we sell is handpicked with care, ensuring you receive the latest technology from trusted manufacturers. At Happy Shop, we believe in making technology accessible and enjoyable, whether you're upgrading your phone, enhancing your home office, or discovering the newest tech trends.  
          </p>
        </div>
        <div data-aos="fade-up-left" data-aos-duration="1000" className="px-5 lg:px-16 xl:px-20 rounded-lg bg-[#EEF0F6]/90 flex justify-center items-center">
          <div className="rounded-lg overflow-hidden">
            <img
      ...
      <div className="py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div data-aos="fade-right" data-aos-duration="1000" className="bg-[#EEF0F6]/90 p-6 rounded-lg">
      ...
      <img src={assets.heart_icon || "/icons/quality.svg"} alt="Quality" className="w-6 h-6" />
            ...
            <h3 className="text-xl font-medium text-gray-600 mb-2">Premium Technology</h3>
            <p className="text-gray-600">We offer only the latest and most innovative devices from trusted brands, ensuring cutting-edge performance, reliability, and exceptional user experience.</p>
          </div>
          
          <div data-aos="zoom-in" data-aos-duration="1000" className="bg-[#EEF0F6]/90 p-6 rounded-lg">
            <div className="w-12 h-12 bg-[#999BA1]/20 rounded-full flex items-center justify-center mb-4">
              <img src={assets.heart_icon || "/icons/sustainability.svg"} alt="Sustainability" className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-medium text-gray-600 mb-2">Expert Support</h3>
            <p className="text-gray-600">Our tech-savvy team provides personalized guidance before purchase and continues with comprehensive after-sales support to ensure you get the most from your devices.</p>
          </div>
          
          <div data-aos="fade-left" data-aos-duration="1000" className="bg-[#EEF0F6]/90 p-6 rounded-lg">
            <div className="w-12 h-12 bg-[#999BA1]/20 rounded-full flex items-center justify-center mb-4">
              <img src={assets.heart_icon || "/icons/imagination.svg"} alt="Imagination" className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-medium text-gray-600 mb-2">Smart Ecosystem</h3>
            <p className="text-gray-600">Discover how our range of smartphones, laptops, and smartwatches work seamlessly together, creating an integrated digital experience that enhances your productivity and lifestyle.</p>
          </div>
        </div>
      </div>
      ...
      <div data-aos="zoom-in" data-aos-duration="1000" className="bg-[#EEF0F6]/90 rounded-lg p-8 my-16">
