        ...
        <div className="bg-[#EEF0F6]/90 p-8 rounded-xl border-[#F8F2EE]/50">
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              <div className="w-10 h-10 bg-[#999BA1]/20 rounded-full flex items-center justify-center flex-shrink-0">
                <img src={assets.map || "/icons/location.svg"} alt="Address" className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-gray-600 font-medium">Visit Us</h3>
                <p className="text-gray-500">123 Tech Lane<br />Galle, YJ 12345<br />Sri Lanka</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-500">(+94) 123-4567</p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-500">happy@shop.com</p>
                <p className="text-gray-500">orders@happyshop.com</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex space-x-4">
            <a href="#" className="w-10 h-10 bg-[#999BA1]/30 rounded-full flex items-center justify-center hover:bg-[#999BA1]/70 transition">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                required
                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500/40 focus:border-transparent resize-none"
              ></textarea>
            </div>
            
            <button
              type="submit"
              className="px-4 py-1.5 bg-[#F88655] text-white hover:bg-orange-500 transition rounded-md w-full md:w-auto"
            >
              Send Message
            </button>
          </form>
          ...
          {[
            {
              ...
              answer: "All of our products are brand new and come directly from authorized manufacturers and distributors. We do not sell refurbished or used items, ensuring that you receive the latest models with full warranty coverage."
            },
            {
            ...
            },
            {
              ...
              answer: "We offer a 30-day return policy for unused items in original packaging. Custom configurations or personalized laptops, PC's cannot be returned unless there is a manufacturing defect."
            },
            {
            ...
            <div key={index} className="bg-[#EEF0F6]/90 p-6 rounded-lg">
